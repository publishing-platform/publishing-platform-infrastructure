// Usage see - https://github.com/alphagov/govuk-ruby-images/blob/main/.github/workflows/sign.yaml
...
data "aws_iam_policy_document" "gha_image_attestation_trust" {
  statement {
    ...
    condition {
      ...
      values   = ["repo:alphagov/publishing-platform-ruby-images:ref:refs/heads/main"]
    }
  }
}
