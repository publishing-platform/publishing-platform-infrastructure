# Moved to shared module temporarily to decouple from this module
# resource "aws_s3_bucket" "content_publisher_activestorage" {
#   bucket = "publishing-platform-${var.publishing_platform_environment}-content-publisher"
# }
...
#   rule {
#     id = "publishing-platform-content-publisher-replication-whole-bucket-rule"
...
#   target_prefix = "s3/publishing-platform-${var.publishing_platform_environment}-content-publisher/"
# }
...
#   bucket   = "publishing-platform-${var.publishing_platform_environment}-content-publisher-replica"
