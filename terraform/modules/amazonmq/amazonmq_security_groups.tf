resource "aws_security_group" "rabbitmq" {
  ...
  tags        = { Name = "publishing_platform_rabbitmq_access" }
}
...
resource "aws_security_group_rule" "publishingamazonmq_ingress_elb_https" {
  type        = "ingress"
  from_port   = 443
  to_port     = 443
  protocol    = "tcp"
...
resource "aws_security_group_rule" "publishingamazonmq_ingress_elb_amqps" {
  type        = "ingress"
  from_port   = 5671
  to_port     = 5671
  protocol    = "tcp"
